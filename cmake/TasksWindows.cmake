...
foreach(_WINDOWS_ARCH IN LISTS _WINDOWS_ARCHS)
	...
	ExternalProject_add(cs-wrapper-${_WINDOWS_ARCH}
		...
		CMAKE_ARGS "-DLINPHONESDK_DIR=${PROJECT_SOURCE_DIR}" "-DLINPHONESDK_INSTALL_DIR=${PROJECT_BINARY_DIR}/linphone-sdk/${_WINDOWS_ARCH_BUILDDIR_NAME}" "-DLINPHONE_PLATFORM=AnyCPU" "-DWINDOWS_VARIANT=NetFramework" "-DBUILD_TYPE=$<IF:$<CONFIG:Debug>,Debug,Release>" ${_WINDOWS_CMAKE_ARGS}
